...
<body class="bg-dark">
    <div class="container"><br>
        <div class="row text-white">
            <?php 
                $sql = mysqli_query($conecta,"SELECT * FROM tb_servico WHERE habilita = 'a'");
                while($row = mysqli_fetch_object($sql)){
            ?>
            <div class="col-3 text-center mb-5">
               <img src="../fotos/<?php echo $row->foto ?>" class="img-responsive rounded-circle" width="130"><br>
                <a style="font-size:30px" href="servico_info.php?id=" <?php $row->pk_id?>><?php echo $row->servico;?></a><br>
            </div>
